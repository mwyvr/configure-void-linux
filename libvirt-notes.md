...
<domain type="kvm">
  <name>win11</name>
  <uuid>66b68919-83e3-4109-9f9f-df507567ad96</uuid>
  <metadata>
    <libosinfo:libosinfo xmlns:libosinfo="http://libosinfo.org/xmlns/libvirt/domain/1.0">
      <libosinfo:os id="http://microsoft.com/win/11"/>
    </libosinfo:libosinfo>
  </metadata>
  <memory unit="KiB">16408576</memory>
  <currentMemory unit="KiB">16408576</currentMemory>
  ...
  <os firmware="efi">
    ...
    <loader readonly="yes" secure="yes" type="pflash">/usr/share/qemu/edk2-x86_64-secure-code.fd</loader>
  ...
  <devices>
    ...
    <input type="evdev">
      <source dev="/dev/input/by-id/usb-_Varmilo-event-kbd" grab="all" repeat="on"/>
    </input>
